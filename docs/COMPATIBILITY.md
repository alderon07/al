...
- Interface and system commands: `status`, `plan`, `theme`, `catalog preview`, `catalog import`, `catalog shadow`, `catalog diff`, `catalog migrate`, `completion`, `shell-init`, `--web`, and `--version`.
